...
public class XGPushPlugin extends CordovaPlugin {
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        XGPushConfig.setMiPushAppId(context, "2882303761517995786");
        XGPushConfig.setMiPushAppKey(context, "5911799546786");
        XGPushConfig.setMzPushAppId(context, "120304");
        XGPushConfig.setMzPushAppKey(context, "f768765028ce4e50b0044dce83cebfda");
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) throws JSONException {
        ...
        if ("unRegisterPush".equals(action)) {
            unRegisterPush(null, callbackContext);
            return true;
        }
