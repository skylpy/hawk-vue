  ...
  let returner = {
    ...
    resolve: {
      ...
      alias: {
        ...
        'gadget': path.resolve(__dirname, 'src/components/gadget'),
      }
    },
    ...
    plugins: [
      new webpack.DefinePlugin({
        'process.env.NODE_ENV': JSON.stringify(process.env.release ? 'production' : 'development'),
        'process.env.HAWK_INDUSTRY': JSON.stringify(process.env.HAWK_INDUSTRY ? process.env.HAWK_INDUSTRY : '')
      }),
