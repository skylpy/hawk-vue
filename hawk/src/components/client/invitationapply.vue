        ...
        <div>
            ...
            <div class="list-item clear-float">
                ...
                <div style="float: right">
                    <input class="item-input"
                           ...
                           @input="formData.contact = $event.target.value" />
                </div>
            </div>
            ...
            <div class="list-item clear-float">
                ...
                <div style="float: right">
                    <input class="item-input"
                           ...
                           @input="formData.contactName = $event.target.value" />
                </div>
            </div>
            ...
            <div class="list-item clear-float textarea-item">
                ...
                <textarea  placeholder="请输入日报内容"
                           ...
                           @input="formData.invitation = $event.target.value">
                </textarea>
            </div>
            ...
            <div class="list-item clear-float textarea-item">
                ...
                <textarea  placeholder="请输入日报内容"
                           :value="formData.des"
                           @input="formData.des = $event.target.value">
                </textarea>
            </div>
...
import {selectAndUpload, getSignUrl, getPreviewUrl} from 'src/lib/aliyun.js';

const hp_default_96 = require("src/assets/images/hp_default_96@2x.png");
const btn_add_people = require("src/assets/images/btn_add_people@2x.png");
const btn_close_small_black = require("src/assets/images/btn_close_small_black@2x.png");
export default {
    ...
    methods: {
        ...
        submit () {
            ...
            if (!this.formData.name.length) {
            ...
            else if (!this.formData.contactName.length) {
                error('请输入邀约人')
            }
            else if (!this.formData.invitation) {
                error('请输入邀约方式')
            }
                ...
                axios.put('/api/invitation/', data).then(resp=>{
                    this.$f7router.back()
                }).catch(err => {
