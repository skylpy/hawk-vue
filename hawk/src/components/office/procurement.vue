<template>
    <f7-page>
        ...
        <f7-block-title>采购申请单</f7-block-title>
        <f7-list>
            <f7-list-item
                    title="申请人"
            ...
            <f7-list-item title="采购说明">
                <textarea
                    :disabled="!stage('edit')"
                    slot = "inner"
                    class="resizable"
                    style="width:80%; text-align:right"
                    placeholder="请说明采购原因(250字内)"
                    maxlength="250"
                    :value="manifesto"
...
export default {
    ...
    mounted: function() {
        ...
        $('select[name="procurementType"]').change(() => {
            this.procurementType = $('select[name="procurementType"] option:checked').attr('value');
        ...
        if (!this.procurementType) {
            this.procurementType = this.myCompany.procurementType[0];
        }
    ...
    methods: {
        ...
        init(application) {
            ...
            this.procurementType = application.content.procurementType;
        ...
        submit() {
            ...
            content.procurementType = this.procurementType;
