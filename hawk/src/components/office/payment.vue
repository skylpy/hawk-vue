<template>
    <f7-page>
        ...
        <f7-block-title>付款申请单</f7-block-title>
        <f7-list>
            <f7-list-item
                    title="申请人"
            ...
            <f7-list-item title="付款说明">
                <textarea
                    :disabled="!stage('edit')"
                    slot = "inner"
                    class="resizable"
                    style="width:80%; text-align:right"
                    placeholder="请说明付款原因(250字内)"
                    maxlength="250"
                    :value="manifesto"
...
export default {
    ...
    mounted: function() {
        ...
        $('select[name="paymentType"]').change(() => {
            this.paymentType = $('select[name="paymentType"] option:checked').attr('value');
        ...
        // set page states
        if (!this.paymentType) {
            this.paymentType = this.myCompany.paymentType[0];
        }
    ...
    methods: {
        ...
        init(application) {
            ...
            this.paymentType = application.content.paymentType;
        ...
        submit() {
            ...
            content.paymentType = this.paymentType;
