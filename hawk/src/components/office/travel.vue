<template>
    <f7-page>
        ...
        <f7-block-title>出差申请单</f7-block-title>
        <f7-list>
            <f7-list-item
                    title="申请人"
            ...
            <f7-list-item title="出差费用">
                <textarea
                    ...
                    placeholder="请说明出差费用"
                    :value="expense"
                    @input="expense = $event.target.value"
                ></textarea>
            </f7-list-item>
            <f7-list-item title="出差原因">
                <textarea
                    :disabled="!stage('edit')"
                    slot = "inner"
                    style="width:70%; text-align:right"
                    class="resizable"
                    placeholder="请说明出差原因(250字)"
                    maxlength="250"
                    :value="manifesto"
